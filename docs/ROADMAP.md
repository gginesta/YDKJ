...
| Milestone | What You Can Do | Target |
|-----------|----------------|--------|
| **M1: First Connection** | Create a room, join with phone, see each other | End of Phase 1 |
| **M2: First Game** | Play 10 multiple choice questions with scoring | End of Phase 2 |
| **M3: The Host Lives** | AI generates questions, host speaks with voice | End of Phase 3 |
| **M4: Full Variety** | All 5 question types + Jack Attack playable | End of Phase 4 |
| **M5: Strategic Depth** | Power-ups, Easter eggs, catch-up mechanics | End of Phase 5 |
| **M6: Looks & Sounds Amazing** | Full pixel art, animations, chiptune audio | End of Phase 6 |
| **M7: Game Night Ready** | Deployed, tested, ready for real game nights | End of Phase 7 |
